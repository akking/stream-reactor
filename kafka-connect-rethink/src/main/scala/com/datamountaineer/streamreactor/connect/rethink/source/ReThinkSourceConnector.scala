...
class ReThinkSourceConnector extends SourceConnector with StrictLogging {
  ...
  override def taskConfigs(maxTasks: Int): util.List[util.Map[String, String]] = {
    ...
    val raw = configProps.asScala.get(ReThinkConfigConstants.SOURCE_ROUTE_QUERY)
    require(raw != null && raw.isDefined, s"No ${ReThinkConfigConstants.SOURCE_ROUTE_QUERY} provided!")
    ...
    groups
      ...
      .map(g => {
        ...
        taskConfigs.put(ReThinkConfigConstants.SOURCE_ROUTE_QUERY, g.mkString(";")) //overwrite
