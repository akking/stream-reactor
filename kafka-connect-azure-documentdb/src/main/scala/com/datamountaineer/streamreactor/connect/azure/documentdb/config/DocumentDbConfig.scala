...
object DocumentDbConfig {
  val configDef: ConfigDef = new ConfigDef()
    ...
    .define(DocumentDbConfigConstants.PROXY_HOST_CONFIG, Type.STRING, null, Importance.LOW, DocumentDbConfigConstants.PROXY_HOST_DOC, "Connection", 6, ConfigDef.Width.MEDIUM, DocumentDbConfigConstants.PROXY_HOST_DISPLAY)
    ...
    .define(DocumentDbConfigConstants.BATCH_SIZE_CONFIG, Type.INT, DocumentDbConfigConstants.BATCH_SIZE_CONFIG_DEFAULT, Importance.MEDIUM, DocumentDbConfigConstants.BATCH_SIZE_DOC, "Mappings", 2, ConfigDef.Width.MEDIUM, DocumentDbConfigConstants.BATCH_SIZE_CONFIG)
